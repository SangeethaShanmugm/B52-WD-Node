...
db.products.find({}, { name: 1, rating: 1 }).sort({ rating: -1 }).limit(5).pretty()


//skip

db.products.find({}, { name: 1, rating: 1 }).sort({ rating: -1 }).limit(5).skip(2).pretty()
...
update category: "laptop" where "Samsung Galaxy Book2 Pro 360 Intel 12th Gen i7 EvoTM 33.78 cm (13.3)"

update category: "accessories" where "SAMSUNG Galaxy Buds2 Pro True Wireless Bluetooth Earbud Headphones - White"

update category: "accessories" where "Samsung Galaxy Watch5 Bluetooth (44 mm, Sapphire, Compatible with Android only)"
